      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <main className="bg-white shadow-xl rounded-lg overflow-hidden">
            <div className="px-6 py-8 sm:px-8 sm:py-10">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* 경력 사항 섹션 */}
                <section>
                  <h2 className="text-lg font-semibold text-gray-900 mb-4">경력 사항</h2>
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="예: React, TypeScript, Node.js 등의 기술을 활용한 웹 개발 경험 3년..."
                      rows={4}
                ...
                {/* 자기소개서 섹션 */}
                <section>
                  <h2 className="text-lg font-semibold text-gray-900 mb-4">자기소개서</h2>
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="지원 동기, 자신만의 강점, 회사에 기여할 수 있는 방향 등을 작성해주세요."
                      rows={6}
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none ${
                ...
                {/* 이력서 업로드 섹션 */}
                <section>
                  <h2 className="text-lg font-semibold text-gray-900 mb-4">이력서 첨부</h2>
                  <div>
                      ...
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                        <div className="space-y-2">
                          ...
                          <div className="text-sm text-gray-600">
                            <label htmlFor="resume-upload" className="cursor-pointer text-blue-600 hover:text-blue-500 font-medium">
                              파일 선택
                            </label>
                            <span className="ml-1">또는 드래그하여 업로드</span>
                          </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500">{(formData.resumeFile.size / 1024 / 1024).toFixed(2)} MB</p>
                            </div>
                          </div>
                          <button
                            type="button"
          ...
          <footer className="text-center mt-8 text-sm text-gray-500">
            <p>문의사항이 있으시면 hr@company.com으로 연락주세요.</p>
          </footer>
        </div>
      </div>
    </>

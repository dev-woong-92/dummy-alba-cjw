    ...
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">최신 아티클</h1>
          <p className="text-slate-600">다양한 주제의 흥미로운 콘텐츠를 만나보세요</p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {(articles || []).map((article) => (
            <article 
              ...
              className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer group overflow-hidden border border-slate-100"
              onClick={() => {
            ...
            >
              ...
              <div className="p-5 flex flex-col h-40">
                ...
                <div className="flex-1 mb-4">
                  <h2 className="text-lg font-bold text-slate-900 mb-2 line-clamp-2 group-hover:text-slate-700 transition-colors">
                    {article?.title || '제목 없음'}
                  </h2>
                ...
                <div className="flex items-center justify-between text-xs text-slate-500">
                  <span className="font-medium">{article?.author || '익명'}</span>
